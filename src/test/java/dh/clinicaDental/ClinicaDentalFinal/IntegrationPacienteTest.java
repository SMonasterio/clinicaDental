...
import dh.clinicaDental.ClinicaDentalFinal.service.DomicilioService;
...
public class IntegrationPacienteTest {
    ...
    public void cargarDataSet() {
        Domicilio domicilio = new Domicilio("Pje Mendez Collado", "9", "Yerba Buena", "Tucumán");
        Paciente p = pacienteService.registrarPaciente(new Paciente("Lucas", "Monasterio", "36258147", new Date(), domicilio));
    }
    @Test
